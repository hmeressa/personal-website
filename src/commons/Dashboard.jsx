      ...
      <div className="flex flex-col w-64 bg-gray-800">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex ">
            Hiluf &nbsp;
            <span className="sm:block hidden"> | Meressa</span>
          </p>
        </Link>
...
const NavLink = ({ to, activeClassName, exact, children }) => {
  ...
  return (
    <Link
      to={`/dashboard/${to}`}
      className={`py-2 px-4 text-white hover:bg-gray-600  flex justify-start items-center gap-2 ${match ? activeClassName : ""
        }`}
    >
      {children}
    </Link>
